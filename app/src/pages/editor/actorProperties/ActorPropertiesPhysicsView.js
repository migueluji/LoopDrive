class ActorPropertiesPhysicsView {
	...
	constructor() {
		...
		this.html.innerHTML =
			...
			'<label class="half-text mdc-text-field mdc-text-field--filled">' +
			'<span class="mdc-text-field__ripple"></span>' +
			'<input id="density" value="1" step="0.1" class="mdc-text-field__input" type="number">' +
			...
			'<label class="half-text mdc-text-field mdc-text-field--filled">' +
			'<span class="mdc-text-field__ripple"></span>' +
			'<input id="friction"  value="1" step="0.1" class="mdc-text-field__input" type="number">' +
			'<span class="mdc-floating-label" >Friction</span>' +
			'<span class="mdc-line-ripple"></span>' +
			'</label>' +
			'<label class="half-text mdc-text-field mdc-text-field--filled">' +
			'<span class="mdc-text-field__ripple"></span>' +
			'<input id="restitution"  value="1" step="0.1"  class="mdc-text-field__input" type="number">' +
